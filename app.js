            ...
            function loadLocalState() {
                try {
                    ...
                    // Автоматически сохраняем в Firebase после загрузки локального состояния
                    setTimeout(() => {
                        saveDataToFirebase();
                    }, 1000);
                    ...
                    // Автоматически сохраняем в Firebase после установки значений по умолчанию
                    setTimeout(() => {
                        saveDataToFirebase();
                    }, 1000);
                }
            ...
            function showWelcomeModal() {
                ...
                // Автоматически сохраняем в Firebase после показа приветствия
                setTimeout(() => {
                    saveDataToFirebase();
                }, 1000);
            ...
            function ensureWeeklyReset() {
                ...
                if (appState.progress.weekStartKey !== currentKey) {
                    ...
                    // Автоматически сохраняем в Firebase после сброса недели
                    setTimeout(() => {
                        saveDataToFirebase();
                    }, 1000);
                }
            ...
            function showTaskModal() {
                ...
                // Автоматически сохраняем в Firebase после показа модального окна заданий
                setTimeout(() => {
                    saveDataToFirebase();
                }, 1000);
            ...
            function showRewardModal() {
                ...
                // Автоматически сохраняем в Firebase после показа модального окна наград
                setTimeout(() => {
                    saveDataToFirebase();
                }, 1000);
            ...
            function showIdeaModal() {
                ...
                // Автоматически сохраняем в Firebase после показа модального окна идей
                setTimeout(() => {
                    saveDataToFirebase();
                }, 1000);
            ...
            function initApp() {
                ...
                // Автоматически сохраняем в Firebase после инициализации
                setTimeout(() => {
                    saveDataToFirebase();
                }, 2000);
                ...
                const showVerificationAfterSync = () => {
                    ...
                    if (hasPin) {
                        ...
                        // Автоматически сохраняем в Firebase после показа верификации
                        setTimeout(() => {
                            saveDataToFirebase();
                        }, 1000);
                        ...
                        // Автоматически сохраняем в Firebase после показа выбора учетной записи
                        setTimeout(() => {
                            saveDataToFirebase();
                        }, 1000);
                ...
                // Автоматически сохраняем в Firebase после обновления UI
                setTimeout(() => {
                    saveDataToFirebase();
                }, 1500);
            ...
            function showAnalyticsModal() {
                ...
                // Автоматически сохраняем в Firebase после показа аналитики
                setTimeout(() => {
                    saveDataToFirebase();
                }, 1000);
            ...
            function updateBestWeekProgress() {
                ...
                if (currentWeekXP > currentBestWeek) {
                    ...
                    // Автоматически сохраняем в Firebase после изменения лучшей недели
                    setTimeout(() => {
                        saveDataToFirebase();
                    }, 1000);
                } else {
            ...
            function showChangeAccountModal() {
                ...
                // Автоматически сохраняем в Firebase после показа смены учетной записи
                setTimeout(() => {
                    saveDataToFirebase();
                }, 1000);
            ...
            function showSetupPinModal() {
                ...
                // Автоматически сохраняем в Firebase после показа установки PIN-кода
                setTimeout(() => {
                    saveDataToFirebase();
                }, 1000);
            ...
            function showChangePinModal() {
                ...
                // Автоматически сохраняем в Firebase после показа смены PIN-кода
                setTimeout(() => {
                    saveDataToFirebase();
                }, 1000);
            ...
            // Save data to Firebase with enhanced UI feedback
            async function saveDataToFirebase() {
                ...
                try {
                    ...
                    const result = await saveStateToFirestore();
            ...
            async function loadStateFromFirestore() {
                ...
                try {
                    ...
                    if (firestoreData) {
                        ...
                        // Автоматически сохраняем в Firebase после загрузки данных
                        setTimeout(() => {
                            saveDataToFirebase();
                        }, 1000);
                ...
                try {
                    ...
                    if (loadResult) {
                        ...
                        if (saveResult) {
                            ...
                            // Автоматически сохраняем в Firebase после успешной синхронизации
                            setTimeout(() => {
                                saveDataToFirebase();
                            }, 1000);
                        } else {
                ...
                try {
                    ...
                    syncWithFirestore().then(syncResult => {
                        ...
                        if (syncResult) {
                            ...
                            // Автоматически сохраняем в Firebase после первичной синхронизации
                            setTimeout(() => {
                                saveDataToFirebase();
                            }, 1000);
            ...
            async function migrateUserDataToShared() {
                ...
                try {
                    ...
                    if (bestData) {
                        ...
                        // Автоматически сохраняем в Firebase после миграции данных
                        setTimeout(() => {
                            saveDataToFirebase();
                        }, 1000);
